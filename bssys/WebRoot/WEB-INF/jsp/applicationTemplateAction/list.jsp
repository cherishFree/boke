...
<div id="MainArea">
    <table cellspacing="0" cellpadding="0" class="TableStyle">
        ...
        <s:iterator value="#applicationTemplateList">
			<tr class="TableDetail1 template">
				...
				<td>
					<s:a action="applicationTemplate_delete?id=%{id}" onclick="return delConfirm()">删除</s:a>
    ...
    <div id="TableTail">
        <div id="TableTail_inside">
			<s:a action="applicationTemplate_addUI"><img src="${pageContext.request.contextPath}/style/images/createNew.png"/></s:a>
        </div>
    </div>
